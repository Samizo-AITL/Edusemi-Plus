...
| 🔬 **応用デバイス / Applied Devices** | **新材料や構造を応用した多様なデバイス群** | **Applied devices: memory, RF, photonics, neuromorphic, energy harvesting, etc.** | [applied-devices](./applied-devices/) |
...
| 🗂️ **アーカイブ / Archive** [![License: Hybrid](https://img.shields.io/badge/license-Hybrid-blueviolet)](https://samizo-aitl.github.io/Edusemi-Plus/archive/#license) | **立ち上げ技術・産業史** | **Ramps & history** | [archive](./archive/) |
