...
| **ライセンス / License** | **Hybrid License**:<br>
**コード（Code）** — MIT License（自由に使用・改変・再配布可）<br>
**教材テキスト（Text materials）** — CC BY 4.0 または CC BY-SA 4.0（著者表示必須、BY-SAの場合は継承条件あり）<br>
**図表・イラスト（Figures & diagrams）** — CC BY-NC 4.0（非商用利用のみ可）<br>
