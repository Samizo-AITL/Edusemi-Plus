...
|---|---|---|---|
| 🧠 **メモリデバイス / Memory Devices** | SRAM, DRAM から FeFET, MRAM, ReRAM, PCM まで | *From SRAM/DRAM to emerging NVMs such as FeFET, MRAM, ReRAM, PCM* | [memory-devices](../Edusemi-v4x/d_chapter1_memory_technologies/) |
