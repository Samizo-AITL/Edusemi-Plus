...
|---|---|
| 📘 [0.18µm RFCMOS Process Flow（教育モデル）](https://samizo-aitl.github.io/Edusemi-Plus/applied-devices/rf-devices/018um_rfcapacitor_extracted) | RFCMOS派生版プロセスフロー（教育モデル）<br>*Derived RFCMOS process flow (educational model)* |
